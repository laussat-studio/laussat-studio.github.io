...
@Metadata {
  ...
  @PageImage(purpose: icon, source: "system-designs-system-design-dimensions-dimensions-data-flows-and-interfaces-icon.codex", alt: "Data Flows and Interfaces icon")
  @PageImage(purpose: card, source: "system-designs-system-design-dimensions-dimensions-data-flows-and-interfaces-card.codex", alt: "Data Flows and Interfaces card")
}
...
@Image(source: "system-designs-system-design-dimensions-dimensions-data-flows-and-interfaces-hero.codex", alt: "Data Flows and Interfaces hero")
