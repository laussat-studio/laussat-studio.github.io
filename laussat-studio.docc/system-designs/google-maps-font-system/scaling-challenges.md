...
@Metadata {
  @PageKind(article)
  @PageColor(gray)
  @PageImage(purpose: icon, source: "system-designs-google-maps-font-system-scaling-challenges-icon.codex", alt: "Scaling challenges coverage icon")
  @PageImage(purpose: card, source: "system-designs-google-maps-font-system-scaling-challenges-card.codex", alt: "Scaling challenges coverage card")
}

@Image(source: "system-designs-google-maps-font-system-scaling-challenges-hero.codex", alt: "Scaling challenges coverage hero")
