...
@Metadata {
  ...
  @PageImage(purpose: icon, source: "system-designs-system-design-dimensions-system-design-dimensions-icon.codex", alt: "System Design Dimensions icon")
  @PageImage(purpose: card, source: "system-designs-system-design-dimensions-system-design-dimensions-card.codex", alt: "System Design Dimensions card")
}
...
@Image(source: "system-designs-system-design-dimensions-system-design-dimensions-hero.codex", alt: "System Design Dimensions hero")
